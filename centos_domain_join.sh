...
authconfig --disablecache --enablewinbind --enablewinbindauth --smbsecurity=ads --smbworkgroup=$DOMAIN_U \
 --smbrealm=$DOMAIN_U.$TLD_U --enablewinbindusedefaultdomain --winbindtemplatehomedir=/home/$DOMAIN_U/%U \
 --winbindtemplateshell=/bin/bash --enablekrb5 --krb5realm=$DOMAIN_U.$TLD_U --enablekrb5kdcdns \
...
echo "Syncing NTP..."
ntpdate $REALM_L.$DOMAIN_L.$TLD_L
